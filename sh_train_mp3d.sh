...
python main.py --auto_gpu_config 0 -n 8 --sem_gpu_id "cuda:3"  --policy_gpu_id "cuda:0" \
    --sim_gpu_id "0,0,2,3"  --split train --backbone_2d  "rednet" --stop_policy "3D" \
    --task_config "tasks/challenge_objectnav2021.local.rgbd.yaml" --dataset "mp3d" \
    --num_sem_categories 21 
    --print_images 1  -d ./tmp --exp_name exp_kl_goal  --save_periodic 20000 
