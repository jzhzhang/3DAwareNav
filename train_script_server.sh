...
python main.py --auto_gpu_config 0 -n 8 --sem_gpu_id "cuda:2"  --policy_gpu_id "cuda:0"  --sim_gpu_id "1,1,3,3"  --split train --backbone_2d  "rednet" --stop_policy "3D" --print_images 1  -d ./tmp --exp_name exp_kl_goal  --save_periodic 20000 
