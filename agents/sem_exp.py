...
class Sem_Exp_Env_Agent(ObjectGoal_Env):
    ...
    def plan_act_and_preprocess(self, planner_inputs):
        ...
        if (self.episode_no-1) % 3==0 and (self.args.visualize or self.args.print_images) or (self.episode_no-1) % 30==0 and (self.args.visualize or self.args.print_images):
        ...
        if (self.episode_no-1) % 30==0 and (self.args.visualize or self.args.print_images) :
